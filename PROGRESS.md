...
- Current execution stage: Phase `7.8.2` (Blackboard index sidebar and toolbar grouping alignment).
...
1. Execute `7.8.2`-`7.8.4`: align Blackboard index/toolbar groupings plus canvas/status polish on top of the completed shell migration.
