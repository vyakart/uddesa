...
- Current execution stage: Phase `7.8.3` (Blackboard canvas theme token alignment).
...
1. Execute `7.8.3`-`7.8.4`: apply Blackboard canvas theme tokens, then finalize status bar/empty-state guidance.
